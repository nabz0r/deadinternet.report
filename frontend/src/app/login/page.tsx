      ...
      <div className="bg-dead-surface border border-dead-border p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="font-mono text-dead-dim text-sm">
            Authenticate to access the scanner
          </p>
        </div>
        ...
        <p className="font-mono text-dead-muted text-xs text-center mt-6">
          Free tier gives you the full dashboard.<br />
          Scanner requires Hunter ($9/mo) or above.
        </p>
      </div>
    </main>
  )
